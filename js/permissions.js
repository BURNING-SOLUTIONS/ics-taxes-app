...
(function () {
	...
	$(document).ready(function () {
		var showOptionsByMenu = function (permissions) {
			...
			var permission_list = ['index-navvar-search', 'index-reports-content', 'clients-range-reports']
...
=======
  	...
  	/* este dejar asi let auth_email_token = "ba845c00-839a-43ab-8c71-af07ee4f2276";
	    Email.send({
